        ...
        <div className="sm:w-full w-full p-2 bg-light-yellow rounded-4xl flex flex-col justify-center items-center shadow-2xl">
            ...
            <div className="skill-gauge w-[95%] flex justify-center items-center my-2">
                <div className="bg-cool-gray relative h-4 w-full rounded-2xl mx-2">
                    <div className={`bg-light-blue-accent absolute top-0 left-0 flex h-full w-${guage} items-center justify-center rounded-2xl text-xs font-semibold text-white`}></div>
                </div>
